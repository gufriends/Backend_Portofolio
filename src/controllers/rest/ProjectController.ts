...
export async function create(c:Context): Promise<TypedResponse> {
    ...
    const serviceResponse = await ProjectService.create(data);

    if (!serviceResponse.status) {
        return handleServiceErrorWithResponse(c, serviceResponse)
    }

    return response_created(c, serviceResponse.data, "Successfully created new Project!");
}
...
export async function getAll(c:Context): Promise<TypedResponse> {
    ...
    return response_success(c, serviceResponse.data, "Successfully fetched all Project!")
}
...
export async function getById(c:Context): Promise<TypedResponse> {
    ...
    return response_success(c, serviceResponse.data, "Successfully fetched Project by id!")
}
...
export async function update(c:Context): Promise<TypedResponse> {
    ...
    return response_success(c, serviceResponse.data, "Successfully updated Project!")
}
...
export async function deleteByIds(c:Context): Promise<TypedResponse> {
    ...
    return response_success(c, serviceResponse.data, "Successfully deleted Project!")
}
